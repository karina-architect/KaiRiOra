...
export function getHeroInfographic(locale: Locale): HeroInfographicContent {
  return {
    ...
    imageAlt: t(locale, {
      en: "Abstract illustration of a connected data and AI architecture, shown as a glowing lattice of linked nodes",
      es: "Ilustración abstracta de una arquitectura conectada de datos e IA, representada como una retícula luminosa de nodos enlazados",
      pt: "Ilustração abstrata de uma arquitetura conectada de dados e IA, representada como uma malha luminosa de nós ligados",
      fr: "Illustration abstraite d'une architecture de données et d'IA connectée, représentée par un maillage lumineux de nœuds reliés",
      de: "Abstrakte Illustration einer vernetzten Daten- und KI-Architektur als leuchtendes Gitter verbundener Knoten",
      ru: "Абстрактная иллюстрация связанной архитектуры данных и ИИ в виде светящейся сети соединённых узлов",
      hu: "Egy összekapcsolt adat- és MI-architektúra absztrakt illusztrációja, világító csomóponthálóként megjelenítve",
    }),
    startLabel: t(locale, {
      en: "Start with",
      es: "Empieza con",
